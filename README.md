...
- Done marker on window title style, cleared on `pane-focus-in`.
...
set -g @agent-indicator-needs-input-window-title-bg ''
set -g @agent-indicator-needs-input-window-title-fg ''
